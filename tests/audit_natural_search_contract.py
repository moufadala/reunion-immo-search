...
natural_search_script_count = html.count('id="naturalSearchV2"')
if natural_search_script_count != 1:
    errors.append(f'naturalSearchV2 script count != 1: {natural_search_script_count}')
