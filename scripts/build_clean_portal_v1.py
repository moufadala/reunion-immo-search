...
$('#resetBtn').onclick=()=>{state={q:'',city:'',type:'',maxPrice:'',minPrice:'',minSurface:'',minRooms:'',minBedrooms:'',minScore:'',sort:'recommended',region:'',zones:''}; hidden.clear(); sessionStorage.removeItem('immo_clean_hidden_session'); localStorage.removeItem('immo_clean_hidden'); syncInputs(); apply();};
